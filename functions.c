 ...
 * @buffer: a buffer array to manage the printing
 * @flags: Calculates included flags
 * @width: the width of values
 * @precision: for precision specification
 * @size: a size specifier
 * Return: all the characters to be printed
 */
 ...
 * @precision: for precision specification
 * @size: a size specifier
 * Return: the number of percentage characters printed
 */
 ...
 * @precision: for precision specification
 * @size: a size specifier
 * Return: the number of integer values  printed
 */
 ...
 * @precision: for precision specification
 * @size: a size specifier
 * Return: the numbers of binary values printed
 */
